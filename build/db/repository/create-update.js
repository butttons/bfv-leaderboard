    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                ...
                if (!hasStats) {
                    return [2 /*return*/, responses_1.response("User **" + ign + "** not found")];
                }
                return [4 /*yield*/, discord_utils_1.getParts(stats)];
            case 3:
                parts = _d.sent();
            ...
            case 7:
                _c;
                return [2 /*return*/, responses_1.response("User **" + ign + "** saved")];
        }
    });
}); };
